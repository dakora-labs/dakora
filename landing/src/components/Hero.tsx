        ...
        <div className="text-center space-y-6 md:space-y-8">
          ...
          >
            <a
              ...
              className="px-8 py-3 bg-blue-500 text-white font-semibold rounded-lg hover:bg-blue-600 transition-all hover:-translate-y-0.5 shadow-md hover:shadow-lg inline-block"
            >
              Create Free Account
            </a>
            <a
